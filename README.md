...
**Note:_ Above services do not guarantee up-to-date source code of Awesome CV**

## Building

### with Tectonic

[Tectonic](http://tectonic-typesetting.github.io) is modern TeX/LaTeX engine powered by XeTeX and TeXLive.

TODO

### Using full TeX distribution

[Various distributions for different operating systems (Windows, Mac, \*nix) are available](http://tex.stackexchange.com/q/55437) but TeX Live is recommended.
